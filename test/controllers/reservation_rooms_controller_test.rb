...
class ReservationRoomsControllerTest < ActionController::TestCase
  ...
  test "should create reservation_room" do
    assert_difference('ReservationRoom.count') do
      post :create, reservation_room: { amount: @reservation_room.amount, reservation_id: @reservation_room.reservation_id, since: @reservation_room.since, until: @reservation_room.until }
    end
  ...
  test "should update reservation_room" do
    patch :update, id: @reservation_room, reservation_room: { amount: @reservation_room.amount, reservation_id: @reservation_room.reservation_id, since: @reservation_room.since, until: @reservation_room.until }
    assert_redirected_to reservation_room_path(assigns(:reservation_room))
  end
